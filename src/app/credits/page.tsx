// src/app/credits/page.tsx — restored original + Streetbeat poster column added
"use client"
        ...
        <div className="mx-auto max-w-5xl flex flex-col md:flex-row gap-8 items-start">
          ...
          */}
          ...
          <div className="flex-1 flex flex-col gap-3 justify-center">
            ...
            {[
              { icon: Award, label: "Academy Award Winner — Best Original Song · \"(I've Had) The Time of My Life\" · 1987" },
